import event from "../assets/img/ic_event_participant@2x.png";
import schedule from "../assets/img/ic_event_schedule@2x.png";
import organ from "../assets/img/ic_organizing_committee@2x.png";
import help from "../assets/img/ic_help_desk@2x.png";
import speaker from "../assets/img/ic_event_speakers@2x.png";
import gallery from "../assets/img/ic_event_gallery@2x.png";
import guide from "../assets/img/ic_city_guide@2x.png";
import feed from "../assets/img/ic_event_feed@2x.png";
import banner from "../assets/img/ic_event_banners@2x.png";
import sponsor from "../assets/img/ic_sponsors@2x.png";
import polls from "../assets/img/ic_polls@2x.png";
import center from "../assets/img/ic_city@2x.png";
import analytics from "../assets/img/ic-analytics@2x.png";
import youtube from "../assets/img/ic_youtube_live@2x.png";
...
export const EventData = [
  ...
  },
  {
    ...
    name: "Event Banners",
    image: banner,
    url: RouteName.EVENT_BANNER,
  },
  {
    key: "youtube_live",
    name: "Youtube Live",
    image: youtube,
    url: RouteName.YOUTUBE_STREEM,
  },
  {
